...
import { Stats, PerformanceMonitor, FlyControls } from '@react-three/drei';
...
interface GameCanvasProps {
    ...
    showDebugHUD?: boolean; // [New] 디버그 HUD 표시 여부
}
...
export const GameCanvas = ({
    ...
    showDebugHUD = false // [New] 기본값 false - 개발자 UI는 '0' 키로 토글
}: GameCanvasProps) => {
    ...
    return (
        <div className="w-full h-screen bg-[#1a1a1a] relative">
            {/* [DEBUG] SCENE INFO OVERLAY - 개발자 모드에서만 표시 */}
            {showDebugHUD && (
            ...
            {/* GameHUD는 GameClient에서 조건부로 렌더링하므로 여기서 제거 */}
