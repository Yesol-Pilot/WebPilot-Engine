...
export function useSpatialPlanner(
    ...
    const handleGeneratePlan = useCallback(async () => {
        ...
        try {
            ...
            if (res.data && res.data.layout) {
                ...
                const furnitureNodes: SceneNode[] = layout.map((item, idx) => {
                    let nodeType: SceneNode['type'] = 'static_mesh';
    ...
    }, [scenario.id, scenario.architecture, scenario.nodes, handleGeneratePlan, isGeneratingPlan]);
