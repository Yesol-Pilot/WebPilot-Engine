...
/**
 * @deprecated [2026-01-21] 호그와트 전용 시나리오입니다. 
 * 범용 시나리오는 '@/data/scenarios'를 사용하세요.
 * Phase 3에서 'src/data/legacy/hogwarts/'로 이동될 예정입니다.
 */
export const HOUSE_SCENARIOS: Record<string, Scenario> = {
    ...
    Slytherin: {
        ...
        nodes: [
            {
                // [NEW] GLB Room Model - slytherin_dorm 키워드로 semanticAssets 매칭
                id: "slytherin_room_model",
                type: "static_mesh",
                description: "슬리데린 기숙사",  // semanticAssets 키워드: "슬리데린", "기숙사"
            ...
            },
            {
                ...
                transform: { position: [0, 2, 8], rotation: [0, 0, 0], scale: [1, 1, 1] }, affordances: [], relationships: []
            }
        ]
    },
    Ravenclaw: {
